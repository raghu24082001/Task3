      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-base font-bold text-slate-800 leading-tight">LeadFlow ERP</p>
              <p className="text-[11px] text-slate-400 leading-tight">Lead Management</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            {/* Notification bell */}
            <button className="relative p-2 rounded-lg text-slate-500 hover:text-indigo-600 hover:bg-indigo-50 transition-colors">
